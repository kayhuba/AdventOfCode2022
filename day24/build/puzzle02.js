...
const findPath = (startPosition, endPosition, startMinute) => {
...
line_reader_1.default.eachLine("./input/input.txt", (line, last) => {
    ...
    if (last) {
        ...
        let endPosition = new Coords(fieldWidth, fieldHeight + 1);
        const reversedPathFirst = findPath(startPosition, endPosition, 0);
        const minutesFirst = reversedPathFirst[0].time;
        ...
        const minutesSecond = reversedPathSecond[0].time;
        ...
        const minutesThird = reversedPathThird[0].time;
